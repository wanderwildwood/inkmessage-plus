...
import com.message.ink.common.util.extensions.fromRecipient
import com.message.ink.common.util.extensions.toPerson
...
) : com.message.ink.manager.NotificationManager {
