...
import com.wanderwildwood.einkmessaging.common.util.FileLoggingTree
import com.wanderwildwood.einkmessaging.injection.AppComponentManager
...
import com.wanderwildwood.einkmessaging.migration.QkMigration
import com.wanderwildwood.einkmessaging.migration.QkRealmMigration
import com.wanderwildwood.einkmessaging.util.NightModeManager
import com.wanderwildwood.einkmessaging.worker.HousekeepingWorker
...
class QKApplication : Application(), HasActivityInjector, HasBroadcastReceiverInjector, HasServiceInjector {
    ...
    @Inject lateinit var prefs: com.wanderwildwood.einkmessaging.util.Preferences
    ...
    override fun onCreate() {
        ...
        com.wanderwildwood.einkmessaging.feature.desktopsync.DesktopSyncService.restoreIfEnabled(this, prefs)
