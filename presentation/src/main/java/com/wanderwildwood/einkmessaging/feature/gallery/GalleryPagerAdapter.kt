 ...
 */
package com.wanderwildwood.einkmessaging.feature.gallery
...
import com.wanderwildwood.einkmessaging.util.GlideApp
import io.reactivex.subjects.PublishSubject
import io.reactivex.subjects.Subject
import java.util.*
import javax.inject.Inject
import com.wanderwildwood.einkmessaging.databinding.GalleryImagePageBinding
import com.wanderwildwood.einkmessaging.databinding.GalleryVideoPageBinding
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            ...
            VIEW_TYPE_VIDEO -> {
                ...
                val dataSourceFactory = DefaultDataSourceFactory(context, Util.getUserAgent(context, "eInk Messaging"))
