 ...
 */
package com.wanderwildwood.einkmessaging.feature.notificationprefs
...
import com.wanderwildwood.einkmessaging.databinding.NotificationPrefsActivityBinding

class NotificationPrefsActivity : QkThemedActivity(), NotificationPrefsView {

    private val binding by lazy { NotificationPrefsActivityBinding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Listen to clicks for all of the binding.preferences
