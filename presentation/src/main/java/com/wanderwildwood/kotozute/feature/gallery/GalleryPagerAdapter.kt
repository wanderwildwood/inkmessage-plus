 ...
 */
package com.wanderwildwood.kotozute.feature.gallery
...
import com.wanderwildwood.kotozute.databinding.GalleryImagePageBinding
import com.wanderwildwood.kotozute.databinding.GalleryVideoPageBinding
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        when (getItemViewType(position)) {
            ...
            VIEW_TYPE_VIDEO -> {
                ...
                val dataSourceFactory = DefaultDataSourceFactory(context, Util.getUserAgent(context, "Messaging"))
